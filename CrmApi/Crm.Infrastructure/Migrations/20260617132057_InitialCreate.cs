        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConvertedLeads = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CacheDurationMinutes = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsStockTrackable = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrorLevel = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Personels_Personels_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActionLogs_Personels_PersonelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: true),
                    CreatedByPersonelId = table.Column<int>(type: "int", nullable: true),
                    AssignedToPersonelId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_Personels_AssignedToPersonelId",
                        column: x => x.AssignedToPersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Customers_Personels_CreatedByPersonelId",
                        column: x => x.CreatedByPersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_Personels_PersonelId",
                        column: x => x.PersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Leads_Personels_AssignedToPersonelId",
                        column: x => x.AssignedToPersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Opportunities_Personels_AssignedToPersonelId",
                        column: x => x.AssignedToPersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tickets_Personels_AssignedToPersonelId",
                        column: x => x.AssignedToPersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tickets_Personels_CreatedByPersonelId",
                        column: x => x.CreatedByPersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedByPersonelId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Meetings_Personels_CreatedByPersonelId",
                        column: x => x.CreatedByPersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Quotes_Personels_CreatedByPersonelId",
                        column: x => x.CreatedByPersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AssignedToPersonelId = table.Column<int>(type: "int", nullable: true),
                    RelatedToCustomerId = table.Column<int>(type: "int", nullable: true),
                    RelatedToLeadId = table.Column<int>(type: "int", nullable: true),
                    RelatedToOpportunityId = table.Column<int>(type: "int", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Priority = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tasks_Customers_RelatedToCustomerId",
                        column: x => x.RelatedToCustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tasks_Leads_RelatedToLeadId",
                        column: x => x.RelatedToLeadId,
                        principalTable: "Leads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tasks_Opportunities_RelatedToOpportunityId",
                        column: x => x.RelatedToOpportunityId,
                        principalTable: "Opportunities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tasks_Personels_AssignedToPersonelId",
                        column: x => x.AssignedToPersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tasks_Personels_CreatedByPersonelId",
                        column: x => x.CreatedByPersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketComments_Personels_PersonelId",
                        column: x => x.PersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MeetingAttendees_Personels_PersonelId",
                        column: x => x.PersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_Personels_CreatedByPersonelId",
                        column: x => x.CreatedByPersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReceivedByPersonelId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_Personels_ReceivedByPersonelId",
                        column: x => x.ReceivedByPersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActionLogs_ActionType_EntityType_CreatedAt",
                table: "ActionLogs",
                columns: new[] { "ActionType", "EntityType", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ActionLogs_PersonelId",
                table: "ActionLogs",
                column: "PersonelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_AssignedToPersonelId",
                table: "Customers",
                column: "AssignedToPersonelId");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_CreatedByPersonelId",
                table: "Customers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ErrorLogs_ErrorLevel_CreatedAt",
                table: "ErrorLogs",
                columns: new[] { "ErrorLevel", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_CreatedByPersonelId",
                table: "Invoices",
                column: "CreatedByPersonelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Leads_AssignedToPersonelId",
                table: "Leads",
                column: "AssignedToPersonelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingAttendees_PersonelId",
                table: "MeetingAttendees",
                column: "PersonelId");

            migrationBuilder.CreateIndex(
                name: "IX_Meetings_CreatedByPersonelId",
                table: "Meetings",
                column: "CreatedByPersonelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_PersonelId_IsRead_CreatedAt",
                table: "Notifications",
                columns: new[] { "PersonelId", "IsRead", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Opportunities_AssignedToPersonelId",
                table: "Opportunities",
                column: "AssignedToPersonelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ReceivedByPersonelId",
                table: "Payments",
                column: "ReceivedByPersonelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Personels_PersonnelNumber",
                table: "Personels",
                column: "PersonnelNumber",
                unique: true,
                filter: "[PersonnelNumber] IS NOT NULL AND [IsDeleted] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Personels_RegistrationNumber",
                table: "Personels",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quotes_CreatedByPersonelId",
                table: "Quotes",
                column: "CreatedByPersonelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_AssignedToPersonelId",
                table: "Tasks",
                column: "AssignedToPersonelId");

            migrationBuilder.CreateIndex(
                name: "IX_Tasks_CreatedByPersonelId",
                table: "Tasks",
                column: "CreatedByPersonelId");

            migrationBuilder.CreateIndex(
                name: "IX_Tasks_RelatedToCustomerId",
                table: "Tasks",
                column: "RelatedToCustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_Tasks_RelatedToLeadId",
                table: "Tasks",
                column: "RelatedToLeadId");

            migrationBuilder.CreateIndex(
                name: "IX_Tasks_RelatedToOpportunityId",
                table: "Tasks",
                column: "RelatedToOpportunityId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketComments_PersonelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_AssignedToPersonelId",
                table: "Tickets",
                column: "AssignedToPersonelId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_CreatedByPersonelId",
                table: "Tickets",
                column: "CreatedByPersonelId");
