// src/pages/contracts/EditContract.jsx
...
export default function EditContract() {
    ...
    const fetchContract = async () => {
        try {
            ...
            if (String(contract.createdByPersonelId) !== String(currentPersonelId)) {
                toast.error('Sadece sözleşmeyi oluşturan kişi düzenleyebilir.');
                navigate('/contracts');
                return;
            }
            ...
            setFormData({
                ...
                startDate: contract.startDate?.slice(0, 16) || '',
                endDate: contract.endDate?.slice(0, 16) || '',
            ...
            toast.error('Sözleşme bilgileri yüklenemedi');
            navigate('/contracts');
        } finally {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error(error.response?.data?.message || 'Sözleşme güncellenemedi');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Sözleşme Düzenle</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400">{formData.contractNumber} nolu sözleşmeyi düzenleyin</p>
                </div>
